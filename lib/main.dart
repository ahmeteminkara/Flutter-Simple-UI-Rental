      ...
      body: ListView(
        children: <Widget>[
          ...
          Container(
            ...
            child: ListView(
              children: <Widget>[
                _buildCard('Gounuli', 'assets/chris.jpg', '3.7',
                ...
                _buildCard('Michelle', 'assets/chris.jpg', '3.9',
                    'The newly decorated new house is well furnished and has a beautiful environment'),
              ],
            ),
          )
                ...
                child: Row(
                  children: <Widget>[
                    ...
                    Column(children: <Widget>[
                      Container(
                        height: 60.0,
                        width: (MediaQuery.of(context).size.width - 90.0) / 4,
                        decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(7.0),
                            image: DecorationImage(
                                image: AssetImage('assets/pic1.jpg'),
            ...
            child: Container(
              ...
              child: PageView.builder(
                  ...
                  itemBuilder: (BuildContext context, int i) {
                    return Container(
                      child: Image.asset(allImgs[i], fit: BoxFit.cover),
                    );
                  }),
            ),
          ),
                  ...
                  Align(
                    ...
                    child: ClipRRect(
                      ...
                      child: SizedBox(
                          height: 80,
                          width: 80,
                          child: Image.asset('assets/hugh.jpg',
                              fit: BoxFit.cover)),
                    ),
                  ),
                ],
